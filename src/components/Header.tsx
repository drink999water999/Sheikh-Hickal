...
import { Menu, X, BookOpen, User, Mic2, GraduationCap, Users, Mail, Star } from "lucide-react";
...
const navItems = [
  ...
  { id: "recitations", label: "الفعاليات", icon: <Mic2 size={18} /> },
  { id: "works", label: "المؤلفات", icon: <BookOpen size={18} /> },
  { id: "services", label: "خدماتنا", icon: <Star size={18} /> },
