...
const experience = [
  { title: "مدرس بالأزهر الشريف", period: "2012 - حتي تاريخه" },
  ...
  { title: "محكم دولي في مسابقات القران و القراءات و الاداء الصوتي", period: "" },
];

const ijazat = [
  { 
    title: "رواية حفص عن عاصم", 
    teachers: ["الشيخ زكريا محمد عبد العاطي", "الشيخ أحمد جبصيني", "الشيخ محمد إبراهيم البدوي (اتمها علي تلميذه الشيخ عبده محمود جبل)"]
  },
  { 
    title: "قراءة عاصم", 
  ...
  { 
    ...
    teachers: ["الشيخ محمود عبد الفتاح أبو كلوب", "الشيخ محمد يونس الغلبان"]
  },
  { 
    ...
    teachers: [
      ...
      "الدكتور محمد سكر", 
      "الشيخ حافظ عثمان شاهين (شيخ قراء تركيا)", 
      "الشيخ محمود أبو كلوب", 
      "الشيخ رمضان نبيه", 
